 ...
 ***************************************************************************/
#ifndef ALGORITHM_FSOL_H
#define ALGORITHM_FSOL_H

#include "algorithm.h"

/**
Simple graph matching algorithm: match vertices with fsoltity permutation matrix

	@author Mikhail Zaslavskiy <mikhail.zaslavskiy@ensmp.fr>
*/
class algorithm_fsol : public algorithm
{
public:
