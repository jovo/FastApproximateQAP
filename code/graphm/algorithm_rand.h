 ...
 ***************************************************************************/
#ifndef ALGORITHM_RAND_H
#define ALGORITHM_RAND_H

#include "algorithm.h"

/**
Simple graph matching algorithm: match vertices with randtity permutation matrix

	@author Mikhail Zaslavskiy <mikhail.zaslavskiy@ensmp.fr>
*/
class algorithm_rand : public algorithm
{
public:
