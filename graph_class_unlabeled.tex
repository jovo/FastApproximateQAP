...
\begin{figure}[htbp]
	\centering
		\includegraphics[width=1.0\linewidth]{../../../figs/graph_sims/unlabeled/homo_kidney_egg_params}
	\caption{caption}
	\label{fig:homo}
\end{figure}
...
\begin{figure}[htbp]
	\centering
		\includegraphics[width=1.0\linewidth]{../../../figs/graph_sims/unlabeled/LPvsFW500}
	\caption{caption}
...
\begin{figure}[!ht]
\centering \includegraphics[width=.9\linewidth]{../../../figs/graph_sims/unlabeled/block_params}
