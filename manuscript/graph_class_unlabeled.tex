...
\subsection{Graph Matching Classifiers} % (fold)
...
\subsubsection{Unlabeled Graph Classification Algorithms} % (fold)
\label{sec:algorithms}
...
\subsubsection{A graph dissimilarity approach: \texttt{$k$NN} $\circ$ \qap} % (fold)
...
\subsubsection{A graph model approach: \texttt{BPI}$\circ$\qap} % (fold)
