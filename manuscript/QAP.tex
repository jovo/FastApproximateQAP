...
\author{Joshua T.~Vogelstein, John C.~Conroy, Lou Podrazik, Steve Kratzer, 
		% Glen A.~Coppersmith, Mark Dredze, 
		% William~R.~Gray,
        R.~Jacob~Vogelstein,
...
\end{align}
where the permutation matrix $Q_{AB}$ induces a labeling of the vertices of $A$ onto those of $B$. A bit of linear algebra simplifies Eq. \eqref{eq:QAP}: % \cite{Horn1990}, and demonstrates that the above objective function 
